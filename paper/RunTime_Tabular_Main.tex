...
and $\sigma_i = \sqrt{\sigma_{\text{floor}}^2 + (k \cdot w_i)^2}$ uses the same adaptive smoothing formula from Section~3. This would enable end-to-end learning of optimal bin boundaries while preserving the ordinal structure that discrete regimes provide.
\clearpage
\appendix
