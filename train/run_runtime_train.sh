...
#
# Override defaults:
#   CONFIG=train/runtime_trainer_adaptive_sigma.yaml WANDB_API_KEY=... bash train/run_runtime_train.sh
#
# Notes:
...
CONFIG="${CONFIG:-${ROOT_DIR}/train/runtime_trainer_adaptive_sigma.yaml}"
